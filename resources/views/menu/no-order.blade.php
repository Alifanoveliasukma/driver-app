...
<div class="d-flex flex-column justify-content-start align-items-center" style="height: calc(100vh - 60px); padding-top: 100px; padding-bottom: 20px;">

  <img src="{{ asset('assets/icon/i-no-order.svg') }}" alt="truck" style="max-width: 250px;">

  <h5 class="text-primary mt-3" style="font-weight: 600;">Tidak Ada Order!</h5>
