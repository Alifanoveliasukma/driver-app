...
<div class="scrollable-content px-3" style="margin-top: 20px; margin-bottom: 100px;">
    ...
    <div class="slide-confirm-container start-0 end-0 px-3" style="bottom: 50px; z-index: 999;">
            <div class="slide-track bg-light rounded shadow-sm d-flex align-items-center justify-content-between px-3 py-2" style="max-width: 400px; margin: 0 auto;" data-redirect="{{ route('utama.konfirmasi-mulai-bongkar') }}">
