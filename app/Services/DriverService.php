...
class DriverService
{
    public function getDriver($cBPartnerId)
    {
                ...
                <adin:queryData>
                    <adin:ModelCRUDRequest>
                        <adin:ModelCRUD>
                            ...
                            <adin:Filter>C_BPartner_ID=' . $cBPartnerId . '</adin:Filter>
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, env('API_URL')); // pastikan API_URL sudah diset di .env
